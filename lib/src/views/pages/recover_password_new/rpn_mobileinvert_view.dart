...
class RpnMobileInvertView extends StatefulWidget {
  RpnController controller;
  RpnMobileInvertView({super.key, required this.controller});

  @override
  State<RpnMobileInvertView> createState() => _RpnMobileInvertViewState();
}

class _RpnMobileInvertViewState extends State<RpnMobileInvertView> {
  @override
