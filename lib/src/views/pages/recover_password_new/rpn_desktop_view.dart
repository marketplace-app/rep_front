...
class RpnDesktopView extends StatefulWidget {
  RpnController controller;
  RpnDesktopView({super.key, required this.controller});

  @override
  State<RpnDesktopView> createState() => _RpnDesktopViewState();
}

class _RpnDesktopViewState extends State<RpnDesktopView> {
  @override
    ...
    return LoginRecoverDesktopComponentView(
      ...
      listWidgets: [
        TitleTextComponentView(
            tittleText: "Digite sua nova senha!", fontSize: 35),
