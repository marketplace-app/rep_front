...
class LoginRecoverMobileComponentView extends StatefulWidget {
  List listWidgets = [];
  String image;
  bool Function(KeyEvent) function;
  double widthImage;
  double heightImage;
  LoginRecoverMobileComponentView(
      {super.key,
      required this.image,
      required this.listWidgets,
      required this.function,
      required this.widthImage, required this.heightImage});

  @override
  State<LoginRecoverMobileComponentView> createState() =>
      _LoginRecoverDesktopComponentViewState();
}

class _LoginRecoverDesktopComponentViewState
    extends State<LoginRecoverMobileComponentView> {
  @override
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Align(
                        child: Image.asset(widget.image, width: widget.widthImage, height: widget.heightImage,),
                      ),
                      //child: Image(image: ),
                    ),
                  ),
